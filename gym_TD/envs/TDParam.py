class Config(object):
    def __init__(self):
        ...
        self.enemy_balance_speed = 0.25
        self.enemy_balance_cost = 3

        self.enemy_strong_LP = 25
        self.enemy_strong_speed = 0.12
        self.enemy_strong_cost = 3

        self.enemy_fast_LP = 8
        self.enemy_fast_speed = 0.45
        self.enemy_fast_cost = 3

        self.attacker_init_cost = 15
        self.defender_init_cost = 15
        self.base_LP = 5
        self.max_cost = 50
        ...
        self.tower_ATKUp_cost = [15, 15]

        self.tower_basic_range = 2
        self.tower_rangeUp_list = [1, 1]
        ...
        self.attacker_cost_final_rate = 1.5
